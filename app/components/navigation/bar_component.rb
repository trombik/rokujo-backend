...
class Navigation::BarComponent < ViewComponent::Base
  ...
  def links
    [
      ...
      DropDownItemComponent.new(label: "Tags", path: collection_tags_path),
      DropDownItemComponent.new(label: "Collections", path: article_collections_path),
      DropDownItemComponent.new(label: "Corpus", path: stats_index_path),
